            ...
            $(document).ready(function () {
                            ...
                            if (msg.error == 0) {
                                ...
                                $.each(msg.dataRes, function (i, item) {
                                    ...
                                    $.each(msg.dataRes[i].mats, function (j, item) {
                                        ...
                                        if (j == 0)
                                            $("#esp #dataEsp tbody").html(cadRes);
                                        if (j == 1)
                                            $("#mate #dataMate tbody").html(cadRes);
                                        if (j == 2)
                                            $("#gen #dataGen tbody").html(cadRes);
                                    });//end J
                                });//end I
                            } else {
                ...
                function calificaciones() {
                    $.ajax({
                        ...
                        success: function (data) {
                            console.log(data);
                            $(".calif #dataCalifMat tbody").html("");
                            $(".calif #dataCalifEsp tbody").html("");
                            $(".calif #dataCalifGen tbody").html("");
                            var msg = jQuery.parseJSON(data);
                            if (msg.error == 0) {
                                //var cadRes = '';
                                $.each(msg.dataRes, function (i, item) {
                                    ...
                                    $.each(msg.dataRes[i].mats, function (j, item) {
                                        ...
                                        console.log(msg.dataRes[i].mats[j]);
                                        if (j == 0)
                                            $(".calif #dataCalifMat tbody").html(cadRes);
                                        if (j == 1)
                                            $(".calif #dataCalifEsp tbody").html(cadRes);
                                        if (j == 2)
                                            $(".calif #dataCalifGen tbody").html(cadRes);
                                    });//end J
                                });//end I
                            } else {
                                $("#mate #dataMate tbody").html('<h2>' + data.msgErr + '</h2>');
