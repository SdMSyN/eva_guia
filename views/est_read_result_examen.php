...
?>
        ...
        <div class="container">
            <div class="row no-margin">
                ...
                <div class="col-md-12 no-padding pricings text-center">
                    <div class="row">
                        <a href="est_read_exam2.php?idNivel=<?=$idNivel;?>&idUser=<?=$idUser;?>" class="btn btn-success">
                            Repetir Examen <span class="glyphicon glyphicon-repeat"></span></a>
                    </div>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        $(document).ready(function(){
            $.ajax({
                method: "POST",
                url: "../controllers/est_read_result_examen.php?idUser=<?=$idUser;?>&idNivel=<?=$idNivel;?>",
