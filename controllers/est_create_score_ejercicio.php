<?php
    ...
    $numCorr = 0; 
    $numErr = 0;
    $sqlGetRespTmp = "SELECT * FROM $tExeTmp WHERE estudiante_id='$idUser' AND banco_nivel_id='$idNivel' ";
    ...
    if($resGetRespTmp->num_rows > 0){
        while($rowGetRespTmp = $resGetRespTmp->fetch_assoc()){
            ...
            $sqlDeleteRespTmp = "DELETE FROM $tExeTmp WHERE id='$idRespTmp' ";
    ...
    if($ban){// Si no hay error guardamos score
        ...
        $sqlGetIdScore = "SELECT id, score, num_intentos FROM $tScoreEj WHERE estudiante_id='$idUser' AND banco_nivel_id='$idNivel' ";
        ...
        if($resGetIdScore->num_rows > 0){//si existe, actualiza
            ...
            if($score > $scoreScore){//actualizamos score y numIntentos
                $updateScore = "UPDATE $tScoreEj SET score='$score', num_intentos='$numInt', actualizado='$dateNow $timeNow' "
                        . "WHERE id='$idScore' ";
                ...
                $updateScoreNumInt = "UPDATE $tScoreEj SET num_intentos='$numInt', actualizado='$dateNow $timeNow' "
                        . "WHERE id='$idScore' ";
            ...
            $sqlInsertScore = "INSERT INTO $tScoreEj "
		...
		$sqlInsertBit = "INSERT INTO $tBBitEje (estudiante_id, score, banco_nivel_id, creado) VALUES ('$idUser', '$score', '$idNivel', '$dateNow $tiemNow')";
