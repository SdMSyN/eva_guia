...
<?php
    ...
    if (!isset($_SESSION['sessU'])){
        ...
        $sqlGetName = "SELECT nombre FROM $tBNivEsc WHERE id='$idNivel' ";
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <ol class="breadcrumb">
                <li><a href="admin_read_banco_niveles_escolares.php"><?=$nameNivel;?></a></li>
        ...
        $(document).ready(function(){
           ...
           function filtrar(){
               $.ajax({
                   type: "POST",
                   data: ordenar, 
                   url: "../controllers/get_materias.php?idNivel="+<?=$idNivel;?>,
                       ...
                       if(msg.error == 0){
                           ...
                           $.each(msg.dataRes, function(i, item){
                               var newRow = '<tr>'
                                    ...
                                    +'<td><a href="admin_read_banco_ejes.php?idMateria='+msg.dataRes[i].id+'" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span></a></td>'
                                    +'</tr>';
                    ...
                    $.ajax({
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'admin_read_banco_materias.php?idNivel='+<?=$idNivel;?>;
                                }, 1500);
                            }else{
